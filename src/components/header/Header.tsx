...
const AppHeader: React.FC = React.memo(() => {
  ...
  useEffect(() => {
    fetch(
      "https://app.ticketmaster.com/discovery/v2/classifications/KZFzniwnSyZfZ7v7nJ?apikey=0JIWxBrWrDwCSXZzhD9HKwPngGfGc9fq"
    )
      .then((response) => response.json())
      .then((response) =>
        setResult({ results: response.segment._embedded.genres })
      )
